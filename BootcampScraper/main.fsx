...
let web = HtmlWeb()
let main = web.Load("https://thdiaman.github.io/machinelearning/modules/tutorial/introduction/")
...
let pages = 
    sidebar.SelectNodes("//a")
     ...
     |> Seq.skipWhile (fun (text,href) -> not <| text.StartsWith("Classification"))
